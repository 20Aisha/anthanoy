...
<Flex pt='20px'>
  ...
  <AccordionItem>
    ...
    <HStack   w={'100%'}  pb={3} >
      ...
      <HStack   w={'100%'}  pb={3} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Years in Business under current ownership (Please choose highest applicable number)</Text> 
        </VStack>
        <VStack  w={'30%'} >
        <Select placeholder="select"  size='sm' borderRadius='5px'  >
                              <option>Not INCLUDED</option>
      ...
      <HStack   w={'100%'}  pb={3} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Number of years of Experience in this or similar line of work</Text> 
        </VStack>
        <VStack  w={'30%'} >
        <Select placeholder="select"  size='sm' borderRadius='5px'  >
                              <option>Not INCLUDED</option>
      ...
      <HStack   w={'100%'}  pb={3} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Number of Years with continuous insurance coverage</Text> 
        </VStack>
        <VStack  w={'30%'} >
        <Select placeholder="-select-"  size='sm' borderRadius='5px'  >
                              <option>Not INCLUDED</option>
      ...
      <HStack   w={'100%'}  pb={3} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Number of Active Owners,Officers,or Partners</Text> 
        </VStack>
        <VStack  w={'30%'} >
    ...
    <HStack pb={3} pt={3}>
      <Text color={'gray'} fontWeight={'bold'}>Nature of Business / Description of Operations</Text>
     </HStack>
     <Textarea  />
    <HStack pb={3} pt={3}>
        <Button colorScheme={'blue'}>Copy from above</Button> <Text color={'gray'} fontWeight={'bold'}>Business Description (MGA use only)</Text>
     </HStack>
     <Textarea  mb={3} />
     <HStack   w={'100%'}  pb={3} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Annual gross sales from all locations and business operations (enter 0 if no sales or not applicable)</Text> 
        </VStack>
        <VStack  w={'30%'} >
        <Input placeholder="-????-"  size='sm' borderRadius='5px'  />
      ...
      <HStack   w={'100%'}  pb={3} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Does the applicant sublet any work</Text> 
        </VStack>
        <VStack  w={'30%'} >
      ...
      <HStack   w={'100%'}  pb={3} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Underwriter</Text> 
        </VStack>
        <VStack  w={'30%'} >
        <Select placeholder="EMGA insp"  size='sm' borderRadius='5px'  >
                              <option>Not INCLUDED</option>
                              <option>INCLUDED</option>
           </Select>
        </VStack>
  ...
  <HStack pt={2}>
             ...
             <HStack w={'45%'} >
                   <Text w={'40%'} >Distance to nearest coast in miles</Text>
                   <Select w={'60%'} >
                    <option>Yes</option>
                    <option>No</option>
                  </Select>
  ...
  <AccordionItem>
    ...
    <HStack  w={'100%'} pb={2}>
     ...
     <HStack w={'100%'} >
      ...
      <HStack   w={'100%'}  pb={1} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Building name/describe/refrence</Text> 
        </VStack>
        <VStack  w={'30%'} >
        <Input size='sm' borderRadius='5px' / >
      ...
      <HStack   w={'100%'}  pb={1} >
        <VStack w={'70%'} alignItems={'flex-start'}>
          <Text>Square Feet of All Floors</Text> 
        </VStack>
        <VStack  w={'30%'} >
        <Input size='sm' borderRadius='5px'  />
